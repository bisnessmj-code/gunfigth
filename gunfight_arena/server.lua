-- ================================================================================================
-- GUNFIGHT ARENA - SERVER v3.3 (STATS DE ZONE EN COURS)
-- ================================================================================================
-- ✅ CORRECTION : Suppression notifications spam
-- ✅ CORRECTION : Touche G affiche stats de la session en cours dans la zone actuelle
-- ✅ Stats globales conservées pour le lobby
-- ================================================================================================
...
-- ✅ NOUVEAU : Stats de session par zone (réinitialisées à chaque entrée dans une zone)
...
AddEventHandler('gunfightarena:getZoneStats', function(zoneNumber)
    ...
    DebugLog("Demande de stats pour la zone " .. zoneNumber .. " par le joueur " .. src)
    ...
    DebugLog("Stats de zone envoyées : " .. #leaderboard .. " joueurs")
