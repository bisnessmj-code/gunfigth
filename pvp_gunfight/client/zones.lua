...
local DAMAGE_CONFIG = {
    damagePerTick = 10,           -- Dégâts infligés par tick
    tickInterval = 4000,         -- Intervalle entre chaque tick (ms)
    warningDistance = 2.0,       -- Distance avant la limite pour afficher un warning
