...
local ELO_CONFIG = {
    kFactors = {
        [1] = 32,  -- Bronze (0-999)
        [2] = 28,  -- Argent (1000-1499)
        [3] = 24,  -- Or (1500-1999)
        [4] = 20,  -- Platine (2000-2499)
        [5] = 18,  -- Émeraude (2500-2999)
        [6] = 15   -- Diamant (3000+)
    },
...
-- ========================================
-- FONCTION PRINCIPALE: CALCULER LE NOUVEAU ELO
-- ========================================
...
-- ========================================
-- FONCTION: METTRE À JOUR L'ELO D'UN JOUEUR (1V1)
-- ========================================
...
-- ========================================
-- FONCTION: METTRE À JOUR L'ELO EN ÉQUIPE (2V2, 3V3, 4V4)
-- ========================================
